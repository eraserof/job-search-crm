 ...
 *
 * <p>State machine (see {@code .kiro/specs/job-search-crm/domain-model.md} § Stage Transition
 * Matrix):
 *
 * <pre>
 *   APPLIED           → RECRUITER_SCREEN, HM_SCREEN, REJECTED, GHOSTED, WITHDRAWN
 *   RECRUITER_SCREEN  → HM_SCREEN, PANEL, ONSITE, REJECTED, GHOSTED, WITHDRAWN
 *   HM_SCREEN         → PANEL, ONSITE, REJECTED, GHOSTED, WITHDRAWN
 *   PANEL             → ONSITE, OFFER, REJECTED, GHOSTED, WITHDRAWN
 *   ONSITE            → OFFER, REJECTED, GHOSTED, WITHDRAWN
 *   OFFER             → REJECTED, WITHDRAWN
 *   REJECTED          → (nothing)                       [terminal]
 *   GHOSTED           → RECRUITER_SCREEN, HM_SCREEN     [re-engagement]
