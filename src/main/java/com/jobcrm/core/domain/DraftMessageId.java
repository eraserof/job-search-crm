 ...
 * messaging} context; the identifier lives here in {@code core} as shared vocabulary so that a
 * {@code Task} (core) can reference a draft without inverting the bounded-context dependency
